...
`.github/workflows/deploy-pages.yml` 會在 `main` 分支的 `ar-fitness/` 有變更時自動建置並部署。

第一次需要在 GitHub repo 的 **Settings → Pages → Build and deployment → Source** 選 **GitHub Actions**。部署後網址為 `https://<帳號>.github.io/Reader/`。
